  ...
  return (
    <div>
      ...
      <audio ref={clickAudioRef} src="/uiselecti.mp3" preload="auto" />
        ...
        <div className="absolute h-[200px] w-full lg:pl-[800px] g:pb-0 sm:pb-[840px] xs:pb-[870px] xs:pl-[16px]" >
        <ul className="flex lg:space-x-14 sm:space-x-14 xs:space-x-10 lg:text-5xl sm:text-3xl lg:pt-[28px] font-amatic sm:pl-[120px] lg:pl-0">
